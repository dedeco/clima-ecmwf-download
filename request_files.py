...
def interim_request(requestDates, target, levtype, params, time, step=None, levelist=None):
    ...
    d = {
        ...
        "grid": "0.75/0.75"         #Optional for GRIB, required for NetCDF. The horizontal resolution in decimal degrees. If not set, the archived grid as specified in the data documentation is used.
    }
